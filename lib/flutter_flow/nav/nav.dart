...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'riderPage',
          path: '/riderPage',
          builder: (context, params) => RiderPageWidget(
            riderDocument: params.getParam(
              'riderDocument',
              ParamType.LatLng,
            ),
          ),
        ...
        FFRoute(
          name: 'updatedLogin',
          path: '/updatedLogin',
          builder: (context, params) => UpdatedLoginWidget(),
        ),
        FFRoute(
          name: 'updatedCreate',
          path: '/updatedCreate',
          builder: (context, params) => UpdatedCreateWidget(),
        )
